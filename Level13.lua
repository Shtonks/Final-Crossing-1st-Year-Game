...
audio.setVolume( 0.07, { channel=4 } )
  ...
  mapData = require "objects.Screen13" -- load from lua export
  ...
  exit1.collision = gotoLevel10

  exit2 = map:findObject("exit2")
  exit2.myName = "exit2"

  exit2.collision = gotoLevel4
